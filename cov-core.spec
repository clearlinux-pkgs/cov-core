...
pushd ..
cp -a cov-core-1.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697573911
...
cp %{_builddir}/cov-core-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/cov-core/07800edab5f4e77a7371e226f11ba91f963a11cf || :
